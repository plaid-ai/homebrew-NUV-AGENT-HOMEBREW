class NuvAgent < Formula
  ...
  url "https://github.com/plaid-ai/NUV-agent/releases/download/v0.1.9/nuv_agent-0.1.9.tar.gz"
  sha256 "3d6881f59c145bb94981d79552db06aeed995773209139bfed51d23df9f7a375"
  version "0.1.9"
  license "Proprietary"
