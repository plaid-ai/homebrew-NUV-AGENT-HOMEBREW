class NuvAgent < Formula
  ...
  url "https://github.com/plaid-ai/NUV-agent/releases/download/v0.1.15/nuv_agent-0.1.15.tar.gz"
  sha256 "f90d7d22862837ba58834efc7d08f35aec08003456d4373d42a1382412a84a7e"
  version "0.1.15"
  license "Proprietary"
