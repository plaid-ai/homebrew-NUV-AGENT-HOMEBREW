class NuvAgent < Formula
  ...
  url "https://github.com/plaid-ai/NUV-agent/releases/download/v0.1.12/nuv_agent-0.1.12.tar.gz"
  sha256 "fffda84add5b8ef2ec884f5c077a1ddae75c2fceb1b1a03a6b57ad4dd0448df4"
  version "0.1.12"
  license "Proprietary"
